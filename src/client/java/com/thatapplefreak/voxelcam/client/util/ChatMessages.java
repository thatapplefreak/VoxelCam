...
public final class ChatMessages {
	...
	/** Sends a message where the body opens a URL when clicked. */
	public static void sendWithLink(String translationKey, String url) {
		MutableText body = Text.translatable(translationKey)
